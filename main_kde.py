...
if __name__ == "__main__":
    ...
    parser.add_argument("--d", "-d", help="Dataset", type=str, default="cifar10") # Change fmnist to other dataset
    parser.add_argument("--m", "-m", help="Model", type=str, default="conv")  # Change resnet to other model
    ...
    fetch_kdes(model, x_train, y_train,layer_names, args)
